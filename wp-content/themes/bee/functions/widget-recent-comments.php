...
?>
		<?php echo $before_widget; ?>
			...
			echo  '<li class="recentcomments"><span class="avatars">' . get_avatar($comment, (empty($options['avatar-size']) ? 28 : $options['avatar-size'])) .'</span>'. /* translators: comments widget: 1: comment author, 2: post link */ sprintf(_x('%2$s', 'widgets', 'ux'), get_comment_author_link(), ' <a href="' . esc_url( get_comment_link($comment->comment_ID) ) . '">' . $aRecentCommentTxt . '</a>') . '</li>';
