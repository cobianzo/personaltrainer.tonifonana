...
class UxShortcodes {
    ...
    function __construct()
    {
    	...
    	define('UX_TINYMCE_URI', get_template_directory_uri(). '/functions/shortcode/tinymce');
		define('UX_TINYMCE_DIR', get_template_directory().'/functions/shortcode/tinymce');
	...
	function admin_init()
	{
		...
		//wp_enqueue_style( 'font-awesome-c', UX_TINYMCE_URI . '/css/font-awesome.css', false, '3.2.1', 'all' );
		...
		wp_localize_script( 'jquery', 'UxShortcodes', array('plugin_folder' =>  get_template_directory_uri(). '/functions/shortcode/', 'dev' => $dev_mode) );
	}
