...
define( 'BLS_BG_IMG',       'bg.jpg' ); // place your 'background'      image in the '/assets/i/background_image' folder.
define( 'BLS_HDR_LOGO',     'logo.png' );      // place your 'header logo'     image in the '/assets/i/logo_main'        folder.
define( 'BLS_RHDR_LOGO',    'logo.png' );   // place your 'responsive logo' image in the '/assets/i/logo_responsive'  folder.
